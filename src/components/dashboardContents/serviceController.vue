                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-select label="Types" v-model="form.types" :items="types" required></v-select>
                            </v-col>
                        </v-row>
                    </v-container>
    ...
    export default {
        ...
        methods: {
            ...
            sendData() {
                ...
                this.service.append('types', this.form.types);
            ...
            deleteData(deleteId) { //mengahapus data
                var uri = this.$apiUrl +
                    '/service/' + deleteId; //da    ta dihapus berdasarkan id
